    ...
    return (
      <div className="player-btns">
        <div className="reverse">
          <button onClick={this.props.reverse}><i className="fa fa-backward" aria-hidden="true"></i></button>
        </div>
        <div className="play">
          <button onClick={this.props.togglePlay}><i className={playPause}></i></button>
        </div>
        <div className="forward">
          <button onClick={this.props.forward}><i className="fa fa-forward" aria-hidden="true"></i></button>
        </div>
      </div>
    );
  }
